...
/**
 * This is the DisplaySingle activity, which accepts a single extra to display to the screen.
 *
...
public class DisplaySingle extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_5_display_single);

        Bundle extras = getIntent().getExtras();
        if (extras != null) {
            to_display = extras.getString("singleChar");
        }
    ...
    public void setImage(String iName) {
        ImageView i = (ImageView) this.findViewById(R.id.singleImage);
